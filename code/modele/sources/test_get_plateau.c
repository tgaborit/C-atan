...
static int infra_teardown(void** state){
    ...
    free_joueur(p->adjacence[4]->t->s[0].owner);
    free_joueur(p->t->s[2].owner);
    freePlateau(p);
    return 0;
}
...
static void test_getProba_PlateauNul(void** state){
...
static void test_getType_PlateauNul(void** state){
...
static void test_getVoleur_PlateauNul(void** state){
...
static void test_getInfrastructureArrete_PlateauNul(void** state){
...
static void test_getJoueurArrete_PlateauNul(void** state){
...
static void test_getInfrastructureSommet_PlateauNul(void** state){
...
static void test_getJoueurSommet_PlateauNul(void** state){
...
int main_get_plateau_test(void){
    const struct CMUnitTest tests_get_plateau[] = {
        ...
        cmocka_unit_test(test_getInfrastructureArrete_PlateauNul),
        ...
        cmocka_unit_test(test_getJoueurArrete_PlateauNul),
        ...
        cmocka_unit_test(test_getInfrastructureSommet_PlateauNul),
        ...
        cmocka_unit_test(test_getJoueurSommet_PlateauNul)
