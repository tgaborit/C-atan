...
/**
* \fn void initPosRectHex(SDL_Rect** hex_rect, int center_x, int center_y, int hexagon_s)
...
void initPosRectHex(SDL_Rect** hex_rect, int center_x, int center_y, int hexagon_s)
{
    ...
    hex_rect[0]->x = center_x - hex_rect[0]->w/2;
    hex_rect[0]->y = center_y - hexagon_s - hex_rect[0]->h/2;

    hex_rect[1]->x = center_x + hexagon_h - hex_rect[0]->w/2;
    hex_rect[1]->y = center_y - hexagon_s/2 - hex_rect[0]->h/2;

    hex_rect[2]->x = center_x + hexagon_h - hex_rect[0]->w/2;
    hex_rect[2]->y = center_y + hexagon_s/2 - hex_rect[0]->h/2;

    hex_rect[3]->x = center_x - hex_rect[0]->w/2;
    hex_rect[3]->y = center_y + hexagon_s - hex_rect[0]->h/2;

    hex_rect[4]->x = center_x - hexagon_h - hex_rect[0]->w/2;
    hex_rect[4]->y = center_y + hexagon_s/2 - hex_rect[0]->h/2;

    hex_rect[5]->x = center_x - hexagon_h - hex_rect[0]->w/2;
    hex_rect[5]->y = center_y - hexagon_s/2 - hex_rect[0]->h/2;
}
