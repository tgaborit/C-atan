...
/**
* \fn void controllerPlaceRoadButton(SDL_MouseButtonEvent button, SDL_bool* pplacing_launched, Game* the_game)
...
* \param[in,out] the_partie Etat de la partie en cours qui sera modifié en fonction des actions du joueur.
*/
void controllerPlaceRoadButton(SDL_MouseButtonEvent mouse_button, SDL_bool* pplacing_launched/*, Game* the_game*/)
{
    ...
    {
    case PATHXX0_BUTTON :
        placeRoadEvent(pplacing_launched/*, the_game,*/, 0, 0, 2);
        break;

    case PATHXX1_BUTTON :
        placeRoadEvent(pplacing_launched/*, the_game,*/, 0, 0, 3);
        break;

    case PATHXX2_BUTTON :
        placeRoadEvent(pplacing_launched/*, the_game,*/, 0, 0, 4);
        break;

    case PATHXX3_BUTTON :
        placeRoadEvent(pplacing_launched/*, the_game,*/, 0, 0, 5);
        break;

    case PATHXX4_BUTTON :
        placeRoadEvent(pplacing_launched/*, the_game,*/, 0, 0, 0);
        break;

    case PATHXX5_BUTTON :
        placeRoadEvent(pplacing_launched/*, the_game,*/, 0, 0, 1);
        break;


    case PATHX0X_BUTTON :
        placeRoadEvent(pplacing_launched/*, the_game,*/, 0.5, 1, 2);
        break;

    case PATHX1X_BUTTON :
        placeRoadEvent(pplacing_launched/*, the_game,*/, 1, 0, 3);
        break;

    case PATHX2X_BUTTON :
        placeRoadEvent(pplacing_launched/*, the_game,*/, 0.5, -1, 4);
        break;

    case PATHX3X_BUTTON :
        placeRoadEvent(pplacing_launched/*, the_game,*/, -0.5, -1, 5);
        break;

    case PATHX4X_BUTTON :
        placeRoadEvent(pplacing_launched/*, the_game,*/, -1, 0, 0);
        break;

    case PATHX5X_BUTTON :
        placeRoadEvent(pplacing_launched/*, the_game,*/, -0.5, 1, 1);
        break;


    case PATH0XX_BUTTON :
        placeRoadEvent(pplacing_launched/*, the_game,*/, 1, 2, 2);
        break;

    case PATH1XX_BUTTON :
        placeRoadEvent(pplacing_launched/*, the_game,*/, 2, 0, 3);
        break;

    case PATH2XX_BUTTON :
        placeRoadEvent(pplacing_launched/*, the_game,*/, 1, -2, 4);
        break;

    case PATH3XX_BUTTON :
        placeRoadEvent(pplacing_launched/*, the_game,*/, -1, -2, 5);
        break;

    case PATH4XX_BUTTON :
        placeRoadEvent(pplacing_launched/*, the_game,*/, -2, 0, 0);
        break;

    case PATH5XX_BUTTON :
        placeRoadEvent(pplacing_launched/*, the_game,*/, -1, 2, 1);
        break;


    case PATHNN0_BUTTON :
        placeRoadEvent(pplacing_launched/*, the_game,*/, 0, 2, 2);
        break;

    case PATHNN1_BUTTON :
        placeRoadEvent(pplacing_launched/*, the_game,*/, 0, 2, 3);
        break;

    case PATHNN2_BUTTON :
        placeRoadEvent(pplacing_launched/*, the_game,*/, 0, 2, 4);
        break;

    case PATHNN3_BUTTON :
        placeRoadEvent(pplacing_launched/*, the_game,*/, 0, 2, 5);
        break;

    case PATHNN4_BUTTON :
        placeRoadEvent(pplacing_launched/*, the_game,*/, 0, 2, 0);
        break;

    case PATHNN5_BUTTON :
        placeRoadEvent(pplacing_launched/*, the_game,*/, 0, 2, 1);
        break;


    case PATHNE0_BUTTON :
        placeRoadEvent(pplacing_launched/*, the_game,*/, 1.5, 1, 2);
        break;

    case PATHNE1_BUTTON :
        placeRoadEvent(pplacing_launched/*, the_game,*/, 1.5, 1, 3);
        break;

    case PATHNE2_BUTTON :
        placeRoadEvent(pplacing_launched/*, the_game,*/, 1.5, 1, 4);
        break;

    case PATHNE3_BUTTON :
        placeRoadEvent(pplacing_launched/*, the_game,*/, 1.5, 1, 5);
        break;

    case PATHNE4_BUTTON :
        placeRoadEvent(pplacing_launched/*, the_game,*/, 1.5, 1, 0);
        break;

    case PATHNE5_BUTTON :
        placeRoadEvent(pplacing_launched/*, the_game,*/, 1.5, 1, 1);
        break;
    ...
    case PATHST0_BUTTON :
        placeRoadEvent(pplacing_launched/*, the_game,*/, 0.5, 1, 0);
        break;

    case PATHST1_BUTTON :
        placeRoadEvent(pplacing_launched/*, the_game,*/, 1, 0, 1);
        break;
    ...
    case PATHST3_BUTTON :
        placeRoadEvent(pplacing_launched/*, the_game,*/, -0.5, 1, 3);
        break;

    case PATHST4_BUTTON :
        placeRoadEvent(pplacing_launched/*, the_game,*/, -1, 0, 4);
        break;
    ...
    case PATHO10_BUTTON :
        placeRoadEvent(pplacing_launched/*, the_game,*/, 1, 2, 3);
        break;

    case PATHO11_BUTTON :
        placeRoadEvent(pplacing_launched/*, the_game,*/, 2, 0, 2);
        break;

    case PATHO20_BUTTON :
        placeRoadEvent(pplacing_launched/*, the_game,*/, 2, 0, 4);
        break;
    ...
    case PATHO40_BUTTON :
        placeRoadEvent(pplacing_launched/*, the_game,*/, -1, -2, 0);
        break;

    case PATHO41_BUTTON :
        placeRoadEvent(pplacing_launched/*, the_game,*/, -2, 0, 5);
        break;

    case PATHO50_BUTTON :
        placeRoadEvent(pplacing_launched/*, the_game,*/, -2, 0, 1);
        break;
...
/**
* \fn void placeRoadEvent(SDL_bool* pplacing_launched, Game* the_game, double x, double y, int position)
